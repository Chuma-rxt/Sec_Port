        ...
        <React.Fragment>
            ...
            >
                ...
                <div className="relative">
                    <div 
                    onClick={openDrawer}
                    className="z-30 absolute cursor-pointer w-14 h-14 lg:w-24 lg:h-24 bg-[#48AFDE] flex justify-center rounded-br-3xl">
                        <div className="relative w-7 lg:wh-10 h-7 lg:h-10 flex justify-center items-center">
                            <img src="download__2_-removebg-preview (1).png" alt="drawer item" className="w-[150px] h-10" />
                        </div>
                ...
                {/* <h1 className="text-7xl">Headeer</h1> */}
